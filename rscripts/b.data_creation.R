...
### 1.TF/IDF features - title, abstract, raw_job_type, raw_location
    ...
    dtm_title <- tfidf_func(text_vector, ngrams = 1, minDocFreq = 2, wordLengths = 2, wordLengths_max = 40, idf = TRUE);
    ...
    dtm_abstract <- tfidf_func(text_vector, ngrams = 1, minDocFreq = 2, wordLengths = 2, wordLengths_max = 40, idf = TRUE)
    ...
    dtm_job_type <- tfidf_func(text_vector, ngrams = 1, minDocFreq = 2,wordLengths = 2, wordLengths_max = 40, idf = TRUE);
    ...
    dtm_location <- tfidf_func(text_vector, ngrams = 1, minDocFreq = 2, wordLengths = 2, wordLengths_max = 40, idf = TRUE);
