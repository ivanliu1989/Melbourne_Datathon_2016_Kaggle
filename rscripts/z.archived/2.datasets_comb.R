...
job_jobs <- job_jobs[!duplicated(job_jobs$job_id),]
...
save(total, file = '../data/model/total2.RData')



job_jobs$job_id[duplicated(job_jobs$job_id)]
job_jobs[job_jobs$job_id == 467404, ]
